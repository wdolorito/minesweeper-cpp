...
../wxWidgets-3.0.3/configure --prefix=/home/vagrant/local-i686 --enable-stl --disable-threads --host=i686-w64-mingw32 --disable-mediactrl --with-msw
make
make install

# compile/install x86_64 wxWidgets
cd /home/vagrant/local/src/wxWidgets-3.0.3-configure-64
../wxWidgets-3.0.3/configure --prefix=/home/vagrant/local-x86_64 --enable-stl --disable-threads --host=x86_64-w64-mingw32 --disable-mediactrl --with-msw
make
make install
